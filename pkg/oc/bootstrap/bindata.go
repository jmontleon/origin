...
// install/ansibleservicebroker/deploy-ansible-service-broker.template.yaml
...
var _installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYaml = []byte(`apiVersion: v1
kind: Template
metadata:
...
func installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYamlBytes() ([]byte, error) {
	return _installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYaml, nil
}

func installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYaml() (*asset, error) {
	bytes, err := installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "install/ansibleservicebroker/deploy-ansible-service-broker.template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"install/ansibleservicebroker/deploy-ansible-service-broker.template.yaml": installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"install": &bintree{nil, map[string]*bintree{
		"ansibleservicebroker": &bintree{nil, map[string]*bintree{
			"deploy-ansible-service-broker.template.yaml": &bintree{installAnsibleservicebrokerDeployAnsibleServiceBrokerTemplateYaml, map[string]*bintree{}},
		}},
